# Generated by Django 5.2.4 on 2025-09-08 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, error_messages={'unique': 'Пользователь с таким номером уже существует!'}, max_length=12, null=True, unique=True, verbose_name='Номер телефона')),
                ...
                ('edit_name', models.BooleanField(default=False, verbose_name='Изменять имя?')),
                ('edit_username', models.BooleanField(default=False, verbose_name='Изменять имя пользователя?')),
